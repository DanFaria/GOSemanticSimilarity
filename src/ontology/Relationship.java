...
//Attributes
	...
	//The subclass property of the relationship (null for 'is_a' relationships)
...
//Constructors
	 ...
	 */
	public Relationship(int dist, String p)
	{
		distance = dist;
		property = p;
	}
...
//Public Methods
	...
	{
		int value = 0;
		if(property == null && r.property == null)
			value = distance - r.distance;
		else if(property == null)
			value = 1;
		else if(r.property == null)
			value = -1;
		return value;
	}
